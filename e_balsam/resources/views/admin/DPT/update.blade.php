  ...
  <input type="hidden" name="_token" value="{{csrf_token()}}">
    <div class="row">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Lengkap" value="{{$detail->nama}}">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-4">
              ...
              <div class="col-sm-8">
                <input type="text" maxlength="22" min="0" name="ktp_passport" class="form-control" id="ktp_passport" placeholder="Nomor @if($detail->kewarganegaraan == 'WNI') KTP @else Passport @endif / Passport" maxlength="22" value="{{$detail->ktp_passport}}">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-4">
              ...
              <div class="col-sm-8">
                <input type="date" name="masa_berlaku_ktp_passport" class="form-control" id="masa_berlaku_ktp_passport" value="{{$detail->masa_berlaku_ktp_passport}}" data-toggle="tooltip" title="Kosongkan Jika Menggunakan 'E-KTP', maka masa berlaku KTP akan dianggap Seumur Hidup">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-4">
              ...
              <div class="col-sm-8">
                <input type="text" name="pekerjaan" class="form-control" id="pekerjaan" placeholder="Pekerjaan" value="{{$detail->pekerjaan}}">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-4">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" maxlength="22" min="0" name="keluarga_ktp_passport" class="form-control" id="keluarga_ktp_passport" placeholder="Nomor KTP / Passport" value="{{$detail->keluarga_ktp_passport}}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" name="keluarga_pekerjaan" class="form-control" id="keluarga_pekerjaan" placeholder="Pekerjaan Keluarga" value="{{$detail->keluarga_pekerjaan}}">
              </div>
            </div>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group col-md-9">
                <input class="form-control" placeholder="Nomor Alas Hak" name="nomor_alas_hak" value="{{$detail->nomor_alas_hak}}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group col-md-9">
                <input class="form-control" placeholder="Nomor Peta Bidang" name="nomor_peta_bidang" value="{{$detail->nomor_peta_bidang}}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group col-md-9">
                <input class="form-control" placeholder="Atas Nama Bidang" name="atas_nama_bidang" value="{{$detail->atas_nama_bidang}}">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="box-body">
            <div class="form-group">
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <input type="number" min="0" name="luas_tanah" class="form-control format" id="luas_tanah" placeholder="Luas Tanah" required="required" value="{{ $detail->luas_tanah }}">
            ...
            <div class="form-group">
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <input type="number" min="0" name="luas_terkena" class="form-control" id="luas_terkena" placeholder="Luas Terkena Tol" required="required" value="{{ $detail->luas_terkena }}">
                  <span class="input-group-addon">M2</span>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="number" min="0" name="harga_tanah" class="form-control" id="harga_tanah" placeholder="Harga Tanah" required="required" value="{{ $detail->harga_tanah }}">
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-11">
                    <div class="input-group">
                      <span class="input-group-addon">Rp.</span>
                        <input type="number" min="0" name="total_harga" class="form-control" id="total_harga" placeholder="Jumlah Tanah Dibayar" disabled value="{{ $detail->total_harga }}">
                      <span class="input-group-addon">.00</span>
                    </div>
                  </div>
                  <div class="col-md-1">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="number" min="0" name="harga_bangunan" class="form-control" id="harga_bangunan" placeholder="Nilai Ganti Bangunan" required="required" value="{{ $detail->harga_bangunan }}">
                  <span class="input-group-addon">.00</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="number" min="0" name="harga_tanaman" class="form-control" id="harga_tanaman" placeholder="Nilai Ganti Tanaman" required="required" value="{{ $detail->harga_tanaman }}">
                  <span class="input-group-addon">.00</span>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-11">
                    <div class="input-group">
                      <span class="input-group-addon">Rp.</span>
                        <input type="number" min="0" name="total_ganti_rugi" id="total_ganti_rugi" class="form-control" id="total_ganti_rugi" placeholder="Jumlah Tanah Keseluruhan Dibayar" disabled value="{{ $detail->total_ganti_rugi }}">
                      <span class="input-group-addon">.00</span>
                    </div>
                  </div>
                  <div class="col-md-1">
          ...
          <div class="box-body">
            <div class="form-group">
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="input-group">
                      <input type="number" min="0" name="luas_tanah_sisa" class="form-control" id="luas_tanah_sisa" placeholder="Luas Tanah Sisa" disabled value="{{$detail->luas_tanah_sisa}}">
                      <span class="input-group-addon">M2</span>
                    </div>
                  </div>
                  <div class="col-md-1">
            ...
            <div class="form-group">
              <div class="col-md-12">
                ...
                <input type="text" name="kondisi_tanah" class="form-control" placeholder="Kondisi Tanah" value="{{$detail->kondisi_tanah}}">
              </div>
            </div>
            <div class="form-group">
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="number" min="0" name="harga_tanah_sisa" class="form-control" id="harga_tanah_sisa" placeholder="Harga Tanah" value="{{$detail->harga_tanah_sisa}}">
                  <span class="input-group-addon">.00</span>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="input-group">
                      <span class="input-group-addon">Rp.</span>
                        <input type="number" min="0" name="total_harga_sisa" class="form-control" id="total_harga_sisa" placeholder="Jumlah Tanah Sisa Dibayar" disabled value="{{$detail->total_harga_sisa}}">
                      <span class="input-group-addon">.00</span>
                    </div>
                  </div>
                  <div class="col-md-1">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="number" name="harga_bangunan_sisa" id="harga_bangunan_sisa" class="form-control" placeholder="Nilai Ganti Kerugian Bangunan" value="{{$detail->harga_bangunan_sisa}}">
                  <span class="input-group-addon">.00</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="number" name="harga_tanaman_sisa" id="harga_tanaman_sisa" class="form-control" placeholder="Nilai Ganti Kerugian Tanaman" value="{{$detail->harga_tanaman_sisa}}">
                  <span class="input-group-addon">.00</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-12">
                ...
                <div class="col-md-10">
                  <div class="input-group">
                    <span class="input-group-addon">Rp.</span>
                      <input type="text" name="total_ganti_rugi_sisa" id="total_ganti_rugi_sisa" class="form-control" placeholder="Total Ganti Rugi Tanah Sisa" disabled="" value="{{$detail->total_ganti_rugi_sisa}}">
                    <span class="input-group-addon">.00</span>
                  </div>
                </div>
                <div class="col-md-1">
          ...
          <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-11">
                    <div class="input-group">
                      <span class="input-group-addon">Rp.</span>
                        <input type="text" name="total_ganti_rugi_semua" id="total_ganti_rugi_semua" class="form-control" placeholder="Total Ganti Rugi" disabled="" value="{{ $detail->total_ganti_rugi + $detail->total_ganti_rugi_sisa }}">
                      <span class="input-group-addon">.00</span>
                    </div>
                  </div>
                  <div class="col-md-1">
            ...
            <div class="form-group">
              <div class="col-md-6">
                ...
                <input type="date" name="tanggal_pembayaran" class="form-control" value="{{$detail->tanggal_pembayaran}}">
              </div>
              <div class="col-md-6">
                <label>Status</label>
      ...
      <div class="col-md-12" id="footer">
        <div class="box box-primary">
          <div class="box-body">
            <button type="submit" class="btn btn-success btn-md pull-left">Simpan Data</button>
          </div>
        </div>
      </div>
    </div>
